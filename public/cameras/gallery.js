...
document.body.insertAdjacentHTML("beforeend", '<div id="js-viewer"><div class="window active"><div class="title-bar"><div class="title-bar-text">Photo</div><div class="title-bar-controls"><button aria-label="Minimize"></button><button aria-label="Maximize"></button><button aria-label="Close"></button></div></div><div class="window-body has-space"><img id="js-viewer-img" src="" /></div></div><span><button id="js-viewer-prev" type="button">Previous</button> <button id="js-viewer-next" type="button">Next</button></span></div>');
